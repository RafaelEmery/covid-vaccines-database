...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{route ('home')}}" class="brand-link">
      <img src="{{asset('favicon.png')}}" alt="Imuniza Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Imuniza</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route ('aplicacao.index')}}" class="nav-link {{ Request::is('aplicacao') ? 'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="{{route ('pessoa.index')}}" class="nav-link {{ Request::is('pessoa') ? 'active' : '' }}">
              <i class="nav-icon fas fa-user-circle"></i>
              <p>Pessoas</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="{{route ('vacina.index')}}" class="nav-link {{ Request::is('vacina') ? 'active' : '' }}">
